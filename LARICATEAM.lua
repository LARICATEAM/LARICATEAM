...
Dev_Info_Sudo:close()
------------------------------------------------------------------------------------------------------------
local Run_File_LARICATEAM = io.open("LARICATEAM", 'w')
Run_File_LARICATEAM:write([[
#!/usr/bin/env bash
...
screen -S ]]..redis:get(Server_Devid.."Token_Devbotuser")..[[ ./LARICATEAM
...
chmod +x LARICATEAM
chmod +x ./NG
cp -a ../LARICATEAM ../]]..redis:get(Server_Devid.."Token_Devbotuser")..[[ &&
rm -fr ~/LARICATEAM
...
Name_Bot = (redis:get(bot_id.."LARICATEAM:Redis:Name:Bot") or "LARICATEAM")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
local Status = redis:sismember(bot_id.."LARICATEAM:Developer:Bot1", user) 
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_Bots_User1 = true  
end  
...
local Dev_Bots_User1 = false  
local Status = redis:sismember(bot_id.."LARICATEAM:Developer:Bot", user) 
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_Bots_User1 = true  
end  
...
local Status = redis:sismember(bot_id.."LARICATEAM:Developer:Bot1", msg.sender_user_id_) 
...
local Status = redis:sismember(bot_id.."LARICATEAM:Developer:Bot", msg.sender_user_id_) 
...
local hash = redis:sismember(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, msg.sender_user_id_) 
...
local hash = redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, msg.sender_user_id_) 
...
function Owner(msg)
local hash = redis:sismember(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_,msg.sender_user_id_)    
...
function Admin(msg)
local hash = redis:sismember(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_,msg.sender_user_id_)    
...
function Vips(msg)
local hash = redis:sismember(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_,msg.sender_user_id_) 
...
Status = true  
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot1", user_id) then
Status = true  
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot", user_id) then
Status = true  
elseif redis:sismember(bot_id.."LARICATEAM:President:Group"..chat_id, user_id) then
Status = true
elseif redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember(bot_id..'LARICATEAM:Manager:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember(bot_id..'LARICATEAM:Admin:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember(bot_id..'LARICATEAM:Vip:Group'..chat_id, user_id) then  
Status = false  
else  
Status = false  
end  
...
Status = "انا البوت :) "
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."LARICATEAM:Developer:Bot:Reply"..chat_id) or "Commander 🎖"  
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot", user_id) then
Status = redis:get(bot_id.."LARICATEAM:Developer:Bot:Reply"..chat_id) or "Commander "  
elseif redis:sismember(bot_id.."LARICATEAM:President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."LARICATEAM:President:Group:Reply"..chat_id) or "المنشئ اساسي"
elseif redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."LARICATEAM:Constructor:Group:Reply"..chat_id) or "المنشئ"  
elseif redis:sismember(bot_id..'LARICATEAM:Manager:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."LARICATEAM:Manager:Group:Reply"..chat_id) or "المدير"  
elseif redis:sismember(bot_id..'LARICATEAM:Admin:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."LARICATEAM:Admin:Group:Reply"..chat_id) or "الادمن"  
elseif redis:sismember(bot_id..'LARICATEAM:Vip:Group'..chat_id, user_id) then  
Status = redis:get(bot_id.."LARICATEAM:Vip:Group:Reply"..chat_id) or "المميز"  
else  
Status = redis:get(bot_id.."LARICATEAM:Mempar:Group:Reply"..chat_id) or "العضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
function ChekBotAdd(chat_id)
if redis:sismember(bot_id.."LARICATEAM:ChekBotAdd",chat_id) then
Status = true
else 
Status = false
end
...
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Group"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Group"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Groups",User_id) then
Status = true
else
Status = false
end
...
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Groups",User_id) then
Status = true
else
Status = false
end
...
local text1 = redis:get(bot_id..'LARICATEAM:new:sourse1') or '━━━━━━━━'
local text2 = redis:get(bot_id..'LARICATEAM:new:sourse2') or '•'
...
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
...
local list = redis:smembers(bot_id..'LARICATEAM:ChekBotAdd') 
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'LARICATEAM Chat'
link = redis:get(bot_id.."LARICATEAM:link:set:Group"..msg.chat_id_) or ''
ASAS = redis:smembers(bot_id..'LARICATEAM:President:Group'..v)
MNSH = redis:smembers(bot_id..'LARICATEAM:Constructor:Group'..v)
MDER = redis:smembers(bot_id..'LARICATEAM:Manager:Group'..v)
MOD = redis:smembers(bot_id..'LARICATEAM:Admin:Group'..v)
if k == 1 then
t = t..'"'..v..'":{"LARICATEAM":"'..NAME..'",'
else
t = t..',"'..v..'":{"LARICATEAM":"'..NAME..'",'
end
if #ASAS ~= 0 then 
...
redis:sadd(bot_id..'LARICATEAM:ChekBotAdd',idg)  
...
redis:sadd(bot_id..'LARICATEAM:Constructor:Group'..idg,idmsh)
end
end
if v.MDER then
for k,idmder in pairs(v.MDER) do
redis:sadd(bot_id..'LARICATEAM:Manager:Group'..idg,idmder)  
end
end
if v.MOD then
for k,idmod in pairs(v.MOD) do
redis:sadd(bot_id..'LARICATEAM:Admin:Group'..idg,idmod)  
end
end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
redis:sadd(bot_id..'LARICATEAM:President:Group'..idg,idASAS)  
end
end
end
...
redis:incr(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) 
TypeForChat = 'ForSuppur' 
elseif id:match("^(%d+)") then
redis:sadd(bot_id..'LARICATEAM:Num:User:Pv',msg.sender_user_id_)  
TypeForChat = 'ForUser' 
else
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Lock:text"..msg.chat_id_) and not Vips(msg) then       
Delete_Message(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(bot_id.."LARICATEAM:Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if redis:get(bot_id.."LARICATEAM:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if redis:get(bot_id.."LARICATEAM:Lock:Join"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Photo"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Photo"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Photo"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Video"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Video"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Video"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Animation"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Animation"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Animation"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:geam"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:geam"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:geam"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Audio"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Audio"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Audio"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:vico"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:vico"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:vico"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Keyboard"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Keyboard"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Keyboard"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Sticker"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Sticker"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Sticker"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:forward"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."LARICATEAM:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."LARICATEAM:Lock:forward"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."LARICATEAM:Lock:forward"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Document"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Document"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Document"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Unsupported"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Unsupported"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Unsupported"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if redis:get(bot_id.."LARICATEAM:Lock:Markdaun"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Markdaun"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Markdaun"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if redis:get(bot_id.."LARICATEAM:Lock:Inlen"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Inlen"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Inlen"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if redis:get(bot_id.."LARICATEAM:Lock:Contact"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Contact"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Contact"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
------------------------------------------------------------------------------------------------------
local status_welcome = redis:get(bot_id.."LARICATEAM:Chek:Welcome"..msg.chat_id_)
if status_welcome and not redis:get(bot_id.."LARICATEAM:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = redis:get(bot_id.."LARICATEAM:Get:Welcome:Group"..msg.chat_id_)  
...
redis:set(bot_id.."LARICATEAM:Get:Id:Msg:Pin"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = redis:get(bot_id.."LARICATEAM:Get:Id:Msg:Pin"..msg.chat_id_)
if Msg_Pin and redis:get(bot_id.."LARICATEAM:lockpin"..msg.chat_id_) then
Pin_Message(msg.chat_id_,Msg_Pin)
end
end
end
--------------------------------------------------------------------------------------------------------------
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= bot_id then
floods = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(redis:get(bot_id.."LARICATEAM:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
redis:setex(bot_id.."LARICATEAM:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--------------------------------------------------------------------------------------------------------------
if msg.content_.photo_ then  
if redis:get(bot_id.."LARICATEAM:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
redis:del(bot_id.."LARICATEAM:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false 
end
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
print(text)
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء الاذاعه للمجموعات") 
redis:del(bot_id.."LARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id.."LARICATEAM:ChekBotAdd") 
...
redis:set(bot_id..'LARICATEAM:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
redis:set(bot_id..'LARICATEAM:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
redis:set(bot_id..'LARICATEAM:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
redis:set(bot_id..'LARICATEAM:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
redis:del(bot_id.."LARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء الاذاعه خاص") 
redis:del(bot_id.."LARICATEAM:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id..'LARICATEAM:Num:User:Pv')  
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء الاذاعه للمجموعات") 
redis:del(bot_id.."LARICATEAM:Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id.."LARICATEAM:ChekBotAdd") 
send(msg.chat_id_, msg.id_,"• تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
...
if redis:get(bot_id.."BotLARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\nتم الغاء الاذاعه للمجموعات") 
redis:del(bot_id.."BotLARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id.."LARICATEAM:ChekBotAdd") 
send(msg.chat_id_, msg.id_,"☑تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
...
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
redis:set(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
for k,v in pairs(list) do 
sendPhoto(v, 0, photo,(msg.content_.caption_ or ""))
redis:set(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
redis:set(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
redis:set(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
redis:del(bot_id.."BotLARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."LARICATEAM:Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء الاذاعه بالترجيه خاص") 
redis:del(bot_id.."LARICATEAM:Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."LARICATEAM:Num:User:Pv")   
...
if redis:get(bot_id.."LARICATEAM:Change:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر تغيير اسم البوت") 
redis:del(bot_id.."LARICATEAM:Change:Name:Bot"..msg.sender_user_id_) 
return false  
end 
redis:del(bot_id.."LARICATEAM:Change:Name:Bot"..msg.sender_user_id_) 
redis:set(bot_id.."LARICATEAM:Redis:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "•  تم تغيير اسم البوت الى - "..text)  
return false
end 
if redis:get(bot_id.."LARICATEAM:Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر تعيين الايدي") 
redis:del(bot_id.."LARICATEAM:Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
redis:del(bot_id.."LARICATEAM:Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) 
redis:set(bot_id.."LARICATEAM:Set:Id:Group"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'• تم تعيين الايدي الجديد')    
end
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Random:Sm"..msg.chat_id_) or "").."" and not redis:get(bot_id.."LARICATEAM:Set:Sma"..msg.chat_id_) then
if not redis:get(bot_id.."LARICATEAM:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - سمايل او سمايلات")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Sma"..msg.chat_id_,true)
return false
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Klam:Speed"..msg.chat_id_) or "").."" and not redis:get(bot_id.."LARICATEAM:Speed:Tr"..msg.chat_id_) then
if not redis:get(bot_id.."LARICATEAM:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Speed:Tr"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Klam:Hzor"..msg.chat_id_) or "").."" and not redis:get(bot_id.."LARICATEAM:Set:Hzora"..msg.chat_id_) then
if not redis:get(bot_id.."LARICATEAM:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - حزوره")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Hzora"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Maany"..msg.chat_id_) or "").."" and not redis:get(bot_id.."LARICATEAM:Set:Maany"..msg.chat_id_) then
if not redis:get(bot_id.."LARICATEAM:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - معاني")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Maany"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Set:Aks:Game"..msg.chat_id_) or "").."" and not redis:get(bot_id.."LARICATEAM:Set:Aks"..msg.chat_id_) then
if not redis:get(bot_id.."LARICATEAM:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - العكس")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Aks"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
...
local GETNUM = redis:get(bot_id.."LARICATEAM:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bot_id.."LARICATEAM:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."LARICATEAM:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"• مبروك فزت ويانه وخمنت الرقم الصحيح\n• تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(bot_id.."LARICATEAM:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(bot_id.."LARICATEAM:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(bot_id.."LARICATEAM:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."LARICATEAM:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
...
local GETNUM = redis:get(bot_id.."LARICATEAM:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bot_id.."LARICATEAM:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"• مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n• لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."LARICATEAM:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not redis:get(bot_id.."LARICATEAM:Set:Moktlf:Bot"..msg.chat_id_) then 
redis:del(bot_id.."LARICATEAM::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Moktlf:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."LARICATEAM:Set:Amth"..msg.chat_id_) or "").."" then 
if not redis:get(bot_id.."LARICATEAM:Set:Amth:Bot"..msg.chat_id_) then 
redis:del(bot_id.."LARICATEAM:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n• لقد فزت في اللعبه \n• اللعب مره اخره وارسل - امثله")
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."LARICATEAM:Set:Amth:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del(bot_id.."LARICATEAM:id:user"..msg.chat_id_)  
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر اضافة رسائل") 
redis:del(bot_id.."LARICATEAM:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
redis:del(bot_id.."LARICATEAM:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = redis:get(bot_id.."LARICATEAM:id:user"..msg.chat_id_)  
redis:del(bot_id.."LARICATEAM:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
redis:incrby(bot_id.."LARICATEAM:Num:Message:User"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_,msg.id_,"\n• تم اضافة له - "..numadded.." رسائل")  
end
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del(bot_id.."LARICATEAM:idgem:user"..msg.chat_id_)  
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر اضافة جواهر") 
redis:del(bot_id.."LARICATEAM:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
redis:del(bot_id.."LARICATEAM:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = redis:get(bot_id.."LARICATEAM:idgem:user"..msg.chat_id_)  
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_,msg.id_,"\n• تم اضافة له - "..numadded.." نقاط")  
end
if text and redis:get(bot_id..'LARICATEAM:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' or text == 'الغاء ✖' then 
redis:del(bot_id..'LARICATEAM:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'• تم الغاء حفظ كليشة Commander ')
return false
end
redis:set(bot_id..'LARICATEAM:Texting:DevSlbotss',text)
redis:del(bot_id..'LARICATEAM:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'• تم حفظ كليشة Commander ')
send(msg.chat_id_,msg.id_,text)
return false
end
if text and redis:get(bot_id..'LARICATEAM:Set:Cmd:Start:Bots') then
if text == 'الغاء' or text == 'الغاء ✖' then    
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ كليشه امر /start") 
redis:del(bot_id..'LARICATEAM:Set:Cmd:Start:Bots') 
return false
end
redis:set(bot_id.."LARICATEAM:Set:Cmd:Start:Bot",text)  
...
local Text_Filter = redis:get(bot_id.."LARICATEAM:Filter:Reply2"..text..msg.chat_id_)   
if Text_Filter then    
...
send(msg.chat_id_,0, "•عذرا يا ⇠ ["..data.first_name_.."](T.ME/LARICATEAM)\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id.."LARICATEAM:Command:Reids:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
redis:set(bot_id.."LARICATEAM:Command:Reids:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• ارسل الامر الجديد ليتم وضعه مكان القديم")  
redis:del(bot_id.."LARICATEAM:Command:Reids:Group"..msg.chat_id_..":"..msg.sender_user_id_)
redis:set(bot_id.."LARICATEAM:Command:Reids:Group:End"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id.."LARICATEAM:Command:Reids:Group:End"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = redis:get(bot_id.."LARICATEAM:Command:Reids:Group:New"..msg.chat_id_)
redis:set(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..text,NewCmd)
redis:sadd(bot_id.."LARICATEAM:Command:List:Group"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• تم حفظ الامر باسم ← { "..text..' }')  
redis:del(bot_id.."LARICATEAM:Command:Reids:Group:End"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if redis:get(bot_id.."LARICATEAM:Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر اضافة صلاحيه") 
local CmdDel = redis:get(bot_id.."LARICATEAM:Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:del(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..CmdDel..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_,CmdDel)  
redis:del(bot_id.."LARICATEAM:Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = redis:get(bot_id.."LARICATEAM:Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:set(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..textn..msg.chat_id_,text)
...
local test = redis:get(bot_id.."LARICATEAM:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if redis:get(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:del(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
redis:set(bot_id.."LARICATEAM:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"• تم حفظ رد بنجاح \n• ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
if redis:get(bot_id.."LARICATEAM:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر اضافة صلاحيه عامه") 
local CmdDel = redis:get(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:del(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt"..CmdDel..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:botsValiditys:Group"..msg.chat_id_,CmdDel)  
redis:del(bot_id.."LARICATEAM:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
...
if text == "مدير" or text == "ادمن" or text == "مميز" or text == "عضو" then
local textn = redis:get(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:set(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt"..textn,text)
...
if redis:get(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n• ارسل لي الرد لاضافته\n• تستطيع اضافة ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n• تستطيع ايضا اضافة :\n• `#username` » معرف المستخدم \n• `#msgs` » عدد الرسائل\n• `#name` » اسم المستخدم\n• `#id` » ايدي المستخدم\n• `#stast` » موقع المستخدم \n• `#edit` » عدد السحكات ')
redis:set(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
redis:set(bot_id.."LARICATEAM:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Text"..text..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Photo"..text..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Video"..text..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:File"..text..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..text..msg.chat_id_)
redis:sadd(bot_id.."LARICATEAM:List:Manager"..msg.chat_id_.."", text)
return false end
end
------------------------------------------------------------------------------------------------------------
if text and text:match("^(.*)$") then
...
if redis:get(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..text..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:List:Manager"..msg.chat_id_.."", text)
return false
end
end
------------------------------------------------------------------------------------------------------------
if text and not redis:get(bot_id.."LARICATEAM:Reply:Sudo"..msg.chat_id_) then
local anemi = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Gif"..text)   
local veico = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:vico"..text)   
local stekr = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:stekr"..text)     
local Text = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Text"..text)   
local photo = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Photo"..text)
local video = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Video"..text)
local document = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:File"..text)
local audio = redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Audio"..text)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = redis:get(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local NumMessageEdit = redis:get(bot_id..'LARICATEAM:Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text and not redis:get(bot_id.."LARICATEAM:Reply:Manager"..msg.chat_id_) then
if not redis:sismember(bot_id..'LARICATEAM:Spam_For_Bot'..msg.sender_user_id_,text) then
local anemi = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = redis:get(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
...
------------------------------------------------------------------------------------------------------------
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = redis:get(bot_id.."LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:del(bot_id.."LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
redis:set(bot_id.."LARICATEAM:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
...
------------------------------------------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if redis:get(bot_id.."LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n• ارسل لي الكلمه الان \n• تستطيع اضافة ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n• تستطيع ايضا اضافة :\n• `#username` » معرف المستخدم \n• `#msgs` » عدد الرسائل\n• `#name` » اسم المستخدم\n• `#id` » ايدي المستخدم\n• `#stast` » موقع المستخدم \n• `#edit` » عدد السحكات ')
redis:set(bot_id.."LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
redis:set(bot_id.."LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
redis:sadd(bot_id.."LARICATEAM:List:Rd:Sudo", text)
return false end
end
------------------------------------------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if redis:get(bot_id.."LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"• تم حذف الرد من الردود العامه ")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
redis:del(bot_id..'LARICATEAM:'..v..text)
end
redis:del(bot_id.."LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:List:Rd:Sudo", text)
return false
end
end
if redis:get(bot_id.."LARICATEAM:Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "• تم الغاء حفظ القوانين") 
redis:del(bot_id.."LARICATEAM:Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
redis:set(bot_id.."LARICATEAM::Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"• تم حفظ قوانين المجموعه") 
redis:del(bot_id.."LARICATEAM:Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
if redis:get(bot_id.."LARICATEAM:Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر تغيير وصف المجموعه") 
redis:del(bot_id.."LARICATEAM:Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
redis:del(bot_id.."LARICATEAM:Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر حفظ الترحيب") 
redis:del(bot_id.."LARICATEAM:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
redis:del(bot_id.."LARICATEAM:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
redis:set(bot_id.."LARICATEAM:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"• تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."LARICATEAM:link:set"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر حفظ الرابط") 
redis:del(bot_id.."LARICATEAM:link:set"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
redis:set(bot_id.."LARICATEAM:link:set:Group"..msg.chat_id_,Link)
...
if text then 
local DelFilter = redis:get(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if DelFilter and DelFilter == "DelFilter" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منعها ")  
redis:del(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
redis:del(bot_id.."LARICATEAM:Filter:Reply2"..text..msg.chat_id_)  
redis:srem(bot_id.."LARICATEAM:List:Filter"..msg.chat_id_,text)  
return false 
end  
end
------------------------------------------------------------------------------------------------------------
if text then   
local SetFilter = redis:get(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if SetFilter and SetFilter == "SetFilter" then   
send(msg.chat_id_, msg.id_,"• ارسل التحذير عند ارسال الكلمه")  
redis:set(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"WirngFilter")  
redis:set(bot_id.."LARICATEAM:Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_, text)  
redis:sadd(bot_id.."LARICATEAM:List:Filter"..msg.chat_id_,text)  
return false  
end  
end
------------------------------------------------------------------------------------------------------------
if text then  
local WirngFilter = redis:get(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if WirngFilter and WirngFilter == "WirngFilter" then  
send(msg.chat_id_, msg.id_,"• تم منع الكلمه مع التحذير")  
redis:del(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = redis:get(bot_id.."LARICATEAM:Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_)  
if text then   
redis:set(bot_id.."LARICATEAM:Filter:Reply2"..test..msg.chat_id_, text)  
end  
redis:del(bot_id.."LARICATEAM:Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_)  
return false 
end  
end
...
if not redis:get(bot_id..'LARICATEAM:Ban:Cmd:Start'..msg.sender_user_id_) then
local GetCmdStart = redis:get(bot_id.."LARICATEAM:Set:Cmd:Start:Bot")  
if not GetCmdStart then 
CmdStart = '\n• اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."LARICATEAM:Redis:Name:Bot") or "نايت رانج")..''..
...
redis:setex(bot_id..'LARICATEAM:Ban:Cmd:Start'..msg.sender_user_id_,60,true)
return false
end
if not Dev_Bots(msg) and not redis:sismember(bot_id..'LARICATEAM:User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'LARICATEAM:Lock:Twasl') then
...
if text == 'حظر' then
redis:sadd(bot_id..'LARICATEAM:User:Ban:Pv',UserForward)  
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","• تم حظره من تواصل البوت")  
return false  
end
if text =='الغاء الحظر' then
redis:srem(bot_id..'LARICATEAM:User:Ban:Pv',UserForward) 
...
redis:set(bot_id.."LARICATEAM:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
redis:del(bot_id.."LARICATEAM:gamebot:List:Manager")
return send(msg.chat_id_, msg.id_,"تم حذف الاسئله")
end
if text and text:match("^(.*)$") then
if redis:get(bot_id.."LARICATEAM:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nتم حفظ السؤال بنجاح')
redis:set(bot_id.."LARICATEAM:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1uu")
redis:sadd(bot_id.."LARICATEAM:gamebot:List:Manager", text)
return false end
end
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/LARICATEAM/main/LARICATEAM.lua')
send(msg.chat_id_, msg.id_,'• تم تحديث السورس')
dofile('LARICATEAM.lua')  
end
if text == 'تغيير كليشه ستارت' then
redis:set(bot_id..'LARICATEAM:Set:Cmd:Start:Bots',true) 
send(msg.chat_id_, msg.id_,'• ارسل الان الكليشه ليتم وضعها') 
end
if text == 'ازالة كليشه ستارت' then
redis:del(bot_id..'LARICATEAM:Set:Cmd:Start:Bot') 
send(msg.chat_id_, msg.id_,'• تم حذف كليشه ستارت') 
end
if text == "تفعيل مغادرة البوت" then   
redis:del(bot_id.."LARICATEAM:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"• تم تفعيل مغادرة البوت") 
end
if text == "تعطيل مغادرة البوت" then  
redis:set(bot_id.."LARICATEAM:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "• تم تعطيل مغادرة البوت") 
end
if text == "تفعيل الاذاعه" then  
redis:del(bot_id.."LARICATEAM:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"• تم تفعيل الاذاعه \n• الان يمكن للCommander  الاذاعه" ) 
end
if text == "تعطيل الاذاعه" then  
redis:set(bot_id.."LARICATEAM:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"• تم تعطيل الاذاعه") 
end
if text == 'تفعيل البوت الخدمي' then  
redis:del(bot_id..'LARICATEAM:Free:Bot') 
send(msg.chat_id_, msg.id_,'• تم تفعيل البوت الخدمي \n• الان يمكن الجميع تفعيله') 
end
if text == 'تعطيل البوت الخدمي' then  
redis:set(bot_id..'LARICATEAM:Free:Bot',true) 
send(msg.chat_id_, msg.id_,'• تم تعطيل البوت الخدمي') 
end
if text == 'تغيير كليشة المطور' then
redis:set(bot_id..'LARICATEAM:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'•  ارسل لي الكليشه الان')
end
if text=="اذاعه خاص" then 
redis:setex(bot_id.."LARICATEAM:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
redis:setex(bot_id.."LARICATEAM:Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي المنشور الان\n• يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n• لالغاء الاذاعه ارسل : الغاء") 
return false
end
if text=="اذاعه بالتوجيه" and DeveloperBot(msg) then 
redis:setex(bot_id.."LARICATEAM:Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان\n• ليتم افتاراته في المجموعات") 
return false
end
if text=="اذاعه خاص بالتوجيه" and DeveloperBot(msg) then 
redis:setex(bot_id.."LARICATEAM:Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان\n• ليتم افتاراته الى المشتركين") 
return false
end
if text == 'ازالة كليشة المطور' then
redis:del(bot_id..'LARICATEAM:Texting:DevSlbotss')
send(msg.chat_id_, msg.id_,'•  تم حذف كليشه Commander ')
end
if text == "تغيير اسم البوت" then 
redis:setex(bot_id.."LARICATEAM:Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"•  ارسل لي الاسم الان ")  
return false
end
if text == ("مسح قائمة العام") then
redis:del(bot_id.."LARICATEAM:Removal:User:Groups")
send(msg.chat_id_, msg.id_, "• تم مسح المحظورين عام من البوت")
end
if text == ("مسح المكتومين عام") then
redis:del(bot_id.."LARICATEAM:Silence:User:Groups")
send(msg.chat_id_, msg.id_, "• تم مسح المحظورين عام من البوت")
end
if text == ("مسح قائمة C") then
redis:del(bot_id.."LARICATEAM:Developer:Bot")
...
local list = redis:smembers(bot_id.."LARICATEAM:Removal:User:Groups")
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Silence:User:Groups")
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Developer:Bot")
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Developer:Bot1")
if #list == 0 then
return send(msg.chat_id_, msg.id_, "• لا يوجد Commander ")
end
Sudos = "\n• قائمة Commander في البوت \n━━━━━━━━\n"
...
send(msg.chat_id_, msg.id_,'*• عدد الاحصائيات الكامله \n━━━━━━━━\n• عدد المجموعات : '..(redis:scard(bot_id..'LARICATEAM:ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(redis:scard(bot_id..'LARICATEAM:Num:User:Pv') or 0)..'*')
end
...
local pv = redis:smembers(bot_id..'LARICATEAM:Num:User:Pv')  
local sendok = 0
for i = 1, #pv do
...
redis:srem(bot_id..'LARICATEAM:Num:User:Pv',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = redis:smembers(bot_id..'LARICATEAM:ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
redis:srem(bot_id..'LARICATEAM:ChekBotAdd',group[i])  
w = w + 1
end
...
redis:del(bot_id..'LARICATEAM:Lock:Twasl') 
send(msg.chat_id_, msg.id_,'•  تم تفعيل التواصل ') 
end
if text == 'تعطيل تواصل' then  
redis:set(bot_id..'LARICATEAM:Lock:Twasl',true) 
...
redis:del(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt"..ComdNew)
redis:srem(bot_id.."LARICATEAM:botsValiditys:Group"..msg.chat_id_,ComdNew)  
...
redis:set(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
redis:sadd(bot_id.."LARICATEAM:botsValiditys:Group"..msg.chat_id_,ComdNew)  
redis:setex(bot_id.."LARICATEAM:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
local statusrt = redis:get(bot_id.."LARICATEAM:botsAdd:Validity:Group:Rt"..mohammed) or redis:get(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..mohammed..msg.chat_id_)
if  statusrt == "مميز" then
if not redis:get(bot_id..'LARICATEAM:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر معل *')
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : الادمنيه فقط *')
end
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)")) 
redis:sadd(bot_id.."LARICATEAM:Vip:Group"..msg.chat_id_,result.sender_user_id_)  
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))
redis:sadd(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_,result.sender_user_id_)  
return Send_Options(msg,result.sender_user_id_,"reply","• تم رفعه "..mohammed)  
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))  
redis:sadd(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_,result.sender_user_id_)  
return Send_Options(msg,result.sender_user_id_,"reply","• تم رفعه "..mohammed)  
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,mohammed) 
redis:srem(bot_id.."LARICATEAM:Vip:Group"..msg.chat_id_,result.sender_user_id_)  
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,mohammed)
redis:srem(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_,result.sender_user_id_)  
return Send_Options(msg,result.sender_user_id_,"reply","• تم تنزيله "..mohammed)  
elseif statusrt == "مدير" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : المنشئين فقط *')
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,mohammed)
redis:srem(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_,result.sender_user_id_)  
return Send_Options(msg,result.sender_user_id_,"reply","• تم تنزيله "..mohammed)  
elseif statusrt == "عضو" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : الادمنيه فقط *')
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:sadd(bot_id.."LARICATEAM:Vip:Group"..msg.chat_id_,result.id_)  
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:sadd(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_,result.id_)  
return Send_Options(msg,result.id_,"reply","• تم رفعه "..mohammed)  
elseif statusrt == "مدير" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : المنشئين فقط *')
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:sadd(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_,result.id_)  
return Send_Options(msg,result.id_,"reply","• تم رفعه "..mohammed)  
elseif statusrt == "عضو" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : الادمنيه فقط *')
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:srem(bot_id.."LARICATEAM:Vip:Group"..msg.chat_id_,result.id_)  
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:srem(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_,result.id_)  
return Send_Options(msg,result.id_,"reply","• تم تنزيله "..mohammed)  
elseif statusrt == "مدير" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : المنشئين فقط *')
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
redis:srem(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_,result.id_)  
return Send_Options(msg,result.id_,"reply","• تم تنزيله "..mohammed)  
elseif statusrt == "عضو" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : الادمنيه فقط *')
...
redis:sadd(bot_id.."LARICATEAM:Removal:User:Groups", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Removal:User:Groups", result.sender_user_id_)
...
redis:sadd(bot_id.."LARICATEAM:Silence:User:Groups", result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Silence:User:Groups", result.sender_user_id_)
...
if redis:get(bot_id..'LARICATEAM:Lock:Ban:Group'..msg.chat_id_) and not Owner(msg) then
...
redis:sadd(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
...
redis:srem(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:srem(bot_id.."LARICATEAM:Silence:kid:User:Group"..msg.chat_id_,result.sender_user_id_)
...
redis:sadd(bot_id.."LARICATEAM:Silence:kid:User:Group"..msg.chat_id_,result.sender_user_id_)
...
redis:sadd(bot_id.."LARICATEAM:Removal:User:Groups", result.id_)
...
redis:srem(bot_id.."LARICATEAM:Removal:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
end
...
redis:sadd(bot_id.."LARICATEAM:Silence:User:Groups", result.id_)
...
redis:srem(bot_id.."LARICATEAM:Silence:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
end
...
redis:sadd(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_, result.id_)
...
redis:srem(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_, result.id_)
...
if text and text:match("^انذار @(.*)$") and Admin(msg) and not redis:get(bot_id..'LARICATEAM:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
if (result.id_) then
if Rank_Checking(result.id_, msg.chat_id_) == true then
return send(msg.chat_id_, msg.id_, "\nلا تستطيع انذار: "..Get_Rank(result.id_,msg.chat_id_).." ")
end
local numinthar = tonumber(redis:get(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.id_,'1')
...
redis:set(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.id_,"reply","تم كتمه \n لانه تجاوز حد 3 انذارات")  
redis:del(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.id_)
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_, result.id_)
end
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
if text == ("انذار") and tonumber(msg.reply_to_message_id_) ~= 0 and Admin(msg) and not redis:get(bot_id..'LARICATEAM:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
return send(msg.chat_id_, msg.id_, "\nلا تستطيع انذار: "..Get_Rank(result.sender_user_id_,msg.chat_id_).." ")
end
local numinthar = tonumber(redis:get(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.sender_user_id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.sender_user_id_,'1')
Send_Options(msg,result.id_,"reply","تم اعطائه انذار \n تبقى له انذارين ويتم كتمه")  
elseif numinthar == 1 then
Send_Options(msg,result.id_,"reply","تم اعطائه انذار \n تبقى له انذار و يتم كتمه")  
redis:set(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.sender_user_id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.id_,"reply","تم كتمه \n لانه تجاوز حد 3 انذارات")  
redis:del(bot_id.."LARICATEAM:inthar"..msg.chat_id_..result.sender_user_id_)
redis:sadd(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
redis:del(bot_id..'LARICATEAM:inthar:group'..msg.chat_id_) 
Text = '\n تم تفعيل الانذارات' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل الانذار' and Admin(msg) then  
redis:set(bot_id..'LARICATEAM:inthar:group'..msg.chat_id_,true) 
Text = '\nتم تعطيل الانذارات' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == 'تفعيل تحقق' and Admin(msg) then   
redis:del(bot_id..'LARICATEAM:nwe:mem:group'..msg.chat_id_) 
Text = '\n تم تفعيل تحقق' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل تحقق' and Admin(msg) then  
redis:set(bot_id..'LARICATEAM:nwe:mem:group'..msg.chat_id_,true) 
Text = '\nتم تعطيل تحقق' 
send(msg.chat_id_, msg.id_,Text) 
end 
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_, result.id_)
...
local list = redis:smembers(bot_id.."LARICATEAM:Silence:kid:User:Group"..msg.chat_id_)
if #list == 0 then
...
redis:sadd(bot_id.."LARICATEAM:Silence:kid:User:Group"..msg.chat_id_,result.id_)
...
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:Silence:kid:User:Group"..msg.chat_id_,result.id_)
...
redis:sadd(bot_id.."LARICATEAM:Removalked:User:Groups", result.id_)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
...
redis:srem(bot_id.."LARICATEAM:Removalked:User:Groups", result.id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
redis:sadd(bot_id.."LARICATEAM:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.sender_user_id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
...
local list = redis:smembers(bot_id.."LARICATEAM:Removalked:User:Groups")
if #list == 0 then
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."LARICATEAM:Developer:Bot", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Developer:Bot", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."LARICATEAM:Developer:Bot1", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Developer:Bot1", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
redis:sadd(bot_id.."LARICATEAM:Developer:Bot", result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:Developer:Bot", result.id_)
...
redis:sadd(bot_id.."LARICATEAM:Developer:Bot1", result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:Developer:Bot1", result.id_)
...
redis:sadd(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.id_)
...
redis:sadd(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
local list = redis:smembers(bot_id.."LARICATEAM:President:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Vips:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_)
if #list == 0 then
...
redis:del(bot_id..'LARICATEAM:tagall'..msg.chat_id_) 
Text = '\n اهلا عزيزي \n تم تفعيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل @all' and Admin(msg) then  
redis:set(bot_id..'LARICATEAM:tagall'..msg.chat_id_,true) 
Text = '\nاهلا عزيزي \n تم تعطيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == ("@all") and Admin(msg) and not redis:get(bot_id..'LARICATEAM:tagall'..msg.chat_id_) then
...
},function(ta,LARICATEAM)
x = 0
tags = 0
local list = LARICATEAM.members_
for k, v in pairs(list) do
...
if text and text:match('@all (.*)') and Admin(msg) and not redis:get(bot_id..'LARICATEAM:tagall'..msg.chat_id_) then
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_
},function(ta,LARICATEAM)
x = 0
...
redis:del(bot_id.."LARICATEAM:Developer:Bot1")
send(msg.chat_id_, msg.id_, "•  تم مسح قائمة C من البوت  ")
end
if text == ("مسح المنشئين الاساسين") and DeveloperBot(msg) or text == "مسح الاساسين" and DeveloperBot(msg) then
redis:del(bot_id.."LARICATEAM:President:Group"..msg.chat_id_)
...
redis:set(bot_id.."LARICATEAM:Lock:text"..msg.chat_id_,true) 
...
redis:set(bot_id.."LARICATEAM:lockpin"..msg.chat_id_, true) 
redis:sadd(bot_id.."LARICATEAM:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  redis:set(bot_id.."LARICATEAM:Get:Id:Msg:Pin"..msg.chat_id_,data.pinned_message_id_)  end,nil)
return Send_Options(msg,msg.sender_user_id_,"Close_Status","• تم قفل التثبيت هنا")  
elseif text ==  "قفل التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:set(bot_id.."LARICATEAM:Lock:edit"..msg.chat_id_,true) 
...
redis:set(bot_id.."LARICATEAM:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
...
redis:del(bot_id.."LARICATEAM:Lock:AddMempar"..msg.chat_id_)  
...
redis:del(bot_id.."LARICATEAM:Lock:tagservr"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","• تم فتح الاشعارات")  
elseif text ==  "فتح التثبيت" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:del(bot_id.."LARICATEAM:lockpin"..msg.chat_id_)  
redis:srem(bot_id.."LARICATEAM:Lock:pin",msg.chat_id_)
return Send_Options(msg,msg.sender_user_id_,"Open_Status","• تم فتح التثبيت هنا")  
elseif text ==  "فتح التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:del(bot_id.."LARICATEAM:Lock:edit"..msg.chat_id_) 
...
redis:del(bot_id.."LARICATEAM:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
...
redis:set(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status","• تم قفل الروابط")  
elseif text ==  "قفل الروابط بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end
redis:set(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_,"ked")  
...
send(msg.chat_id_, msg.id_,'• عليك الاشتراك بقناة السورس \n • قناة السورس - [@LARICATEAM] ') 
return false
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end  
redis:set(bot_id..'LARICATEAM:Link_Group'..msg.chat_id_,true) 
...
redis:del(bot_id..'LARICATEAM:Link_Group'..msg.chat_id_) 
...
redis:set(bot_id..'LARICATEAM:Chek:Welcome'..msg.chat_id_,true) 
...
redis:del(bot_id..'LARICATEAM:Chek:Welcome'..msg.chat_id_) 
...
redis:del(bot_id..'LARICATEAM:Reply:Manager'..msg.chat_id_)  
...
redis:set(bot_id..'LARICATEAM:Reply:Manager'..msg.chat_id_,true)  
...
redis:del(bot_id..'LARICATEAM:Reply:Sudo'..msg.chat_id_)  
...
redis:set(bot_id..'LARICATEAM:Reply:Sudo'..msg.chat_id_,true)   
...
redis:del(bot_id..'LARICATEAM:Cheking:Kick:Me:Group'..msg.chat_id_)  
...
redis:set(bot_id..'LARICATEAM:Cheking:Kick:Me:Group'..msg.chat_id_,true)  
...
redis:setex(bot_id.."BotLARICATEAM:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ارسل لي المنشور الان\nيمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n⚠لالغاء الاذاعه ارسل : الغاء") 
return false
end
...
redis:del(bot_id..'LARICATEAM:Lock:Id:Photo'..msg.chat_id_) 
...
redis:set(bot_id..'LARICATEAM:Lock:Id:Photo'..msg.chat_id_,true) 
...
redis:del(bot_id..'LARICATEAM:Lock:Id:Py:Photo'..msg.chat_id_) 
...
redis:set(bot_id..'LARICATEAM:Lock:Id:Py:Photo'..msg.chat_id_,true) 
...
redis:del(bot_id..'LARICATEAM:Lock:Game:Group'..msg.chat_id_) 
...
redis:set(bot_id..'LARICATEAM:Lock:Game:Group'..msg.chat_id_,true) 
...
redis:set(bot_id..'LARICATEAM:Lock:Ban:Group'..msg.chat_id_,'true')
...
redis:del(bot_id..'LARICATEAM:Lock:Ban:Group'..msg.chat_id_)
...
redis:set(bot_id..'LARICATEAM:Cheking:Seted'..msg.chat_id_,'true')
...
redis:del(bot_id..'LARICATEAM:Cheking:Seted'..msg.chat_id_)
...
local Added_Me = redis:get(bot_id.."LARICATEAM:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
redis:setex(bot_id.."LARICATEAM:link:set"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false 
end
...
redis:set(bot_id.."LARICATEAM:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
send(msg.chat_id_,msg.id_,"• ارسل الصوره لوضعها") 
return false 
end
if text == "ضع وصف" and Admin(msg) or text == "وضع وصف" and Admin(msg) then  
redis:setex(bot_id.."LARICATEAM:Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
send(msg.chat_id_,msg.id_,"• ارسل الان الوصف")
return false 
end
if text == "ضع ترحيب" and Admin(msg) or text == "وضع ترحيب" and Admin(msg) then  
redis:setex(bot_id.."LARICATEAM:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
send(msg.chat_id_,msg.id_,"• ارسل لي الترحيب الان".."\n• تستطيع اضافة مايلي !\n• دالة عرض الاسم »{`name`}\n• دالة عرض المعرف »{`user`}") 
return false 
end
if text == "ضع قوانين" and Admin(msg) or text == "وضع قوانين" and Admin(msg) then 
redis:setex(bot_id.."LARICATEAM:Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
local status_Link = redis:get(bot_id.."LARICATEAM:Link_Group"..msg.chat_id_)
local link = redis:get(bot_id.."LARICATEAM:link:set:Group"..msg.chat_id_)     
...
if redis:get(bot_id.."LARICATEAM:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = redis:get(bot_id.."LARICATEAM:Get:Welcome:Group"..msg.chat_id_)  
else 
...
local Set_Rules = redis:get(bot_id.."LARICATEAM::Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
redis:del(bot_id.."LARICATEAM:link:set:Group"..msg.chat_id_) 
return false 
end
...
redis:del(bot_id.."LARICATEAM:Get:Welcome:Group"..msg.chat_id_) 
...
redis:del(bot_id.."LARICATEAM::Rules:Group"..msg.chat_id_) 
return false 
end
...
redis:del(bot_id.."LARICATEAM:Set:Id:Group"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '• تم ازالة كليشة الايدي ')
return false 
end
if text == 'مسح رسائلي' then
redis:del(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,'• تم مسح جميع رسائلك ') 
return false 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
redis:del(bot_id..'LARICATEAM:Num:Message:Edit'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,'• تم مسح جميع تعديلاتك ') 
return false 
end
if text == 'مسح جهاتي' then
redis:del(bot_id..'LARICATEAM:Num:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
redis:hset(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,text:match("^وضع تكرار (%d+)$")) 
...
redis:hset(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,text:match("^وضع زمن التكرار (%d+)$")) 
...
local list = redis:smembers(bot_id.."LARICATEAM:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
redis:del(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
redis:del(bot_id.."LARICATEAM:Filter:Reply2"..v..msg.chat_id_)  
redis:srem(bot_id.."LARICATEAM:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n• قائمة المنع \n━━━━━━━━\n"
for k,v in pairs(list) do  
local FilterMsg = redis:get(bot_id.."LARICATEAM:Filter:Reply2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FilterMsg.."}\n"    
end  
if #list == 0 then  
...
redis:set(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"SetFilter")  
return false  
end
...
redis:set(bot_id.."LARICATEAM:Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"DelFilter")  
return false 
end
...
if redis:sismember(bot_id.."LARICATEAM:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
redis:set(bot_id.."LARICATEAM:Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
return false 
end
...
redis:del(bot_id.."LARICATEAM:Get:Id:Msg:Pin"..msg.chat_id_)
return false 
end
if data.code_ == 6 then
send(msg.chat_id_,msg.id_,"• البوت ليس ادمن هنا")  
...
if redis:sismember(bot_id.."LARICATEAM:Developer:Bot1",result.id_) then
dev = "Commander 🎖 ،" else dev = "" end
if redis:sismember(bot_id.."LARICATEAM:Developer:Bot",result.id_) then
dev = "Commander  ،" else dev = "" end
if redis:sismember(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if redis:sismember(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if redis:sismember(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if redis:sismember(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot1",msg.sender_user_id_) then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id.."LARICATEAM:President:Group"..msg.chat_id_,result.id_)
elseif redis:sismember(bot_id.."LARICATEAM:Developer:Bot",msg.sender_user_id_) then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id.."LARICATEAM:President:Group"..msg.chat_id_,result.id_)
elseif redis:sismember(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.id_)
end
end
...
if redis:sismember(bot_id.."LARICATEAM:Developer:Bot1",result.sender_user_id_) then
dev = "Commander 🎖 ،" else dev = "" end
if redis:sismember(bot_id.."LARICATEAM:Developer:Bot",result.sender_user_id_) then
dev = "Commander  ،" else dev = "" end
if redis:sismember(bot_id.."LARICATEAM:President:Group"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if redis:sismember(bot_id..'LARICATEAM:Constructor:Group'..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if redis:sismember(bot_id..'LARICATEAM:Manager:Group'..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if redis:sismember(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if redis:sismember(bot_id..'LARICATEAM:Vip:Group'..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
if DeveloperBot(msg) and not redis:get(bot_id.."LARICATEAM:Lock:Left"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"-") 
redis:srem(bot_id.."LARICATEAM:ChekBotAdd",msg.chat_id_)  
end
end
...
redis:srem(bot_id.."LARICATEAM:ChekBotAdd",GP_ID[2])  
end
end
...
if redis:get(bot_id.."LARICATEAM:lockpin"..msg.chat_id_) then    
lock_pin = "✔️"
else 
lock_pin = "✖"    
end
if redis:get(bot_id.."LARICATEAM:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "✖"
end
if redis:get(bot_id.."LARICATEAM:Lock:text"..msg.chat_id_) then    
lock_text = "← ✔️"
else 
lock_text = "← ✖"    
end
...
if redis:get(bot_id.."LARICATEAM:Lock:edit"..msg.chat_id_) then    
lock_edit = "← ✔️"
else 
lock_edit = "← ✖"    
end
if redis:get(bot_id.."LARICATEAM:Chek:Welcome"..msg.chat_id_) then
welcome = "← ✔️"
else 
welcome = "← ✖"    
end
if redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "← بالطرد"     
elseif redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "← بالتقييد "     
elseif redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "← بالكتم"           
elseif redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "← ✔️"
else     
flood = "← ✖"     
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "← بالتقييد "    
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "← بالكتم"    
elseif redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "← بالطرد"    
else
lock_links = "← ✖"    
end
if redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "← بالتقييد "    
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "← بالكتم"   
elseif redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "← بالطرد"    
else
lock_cmds = "← ✖"    
end
if redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "← بالتقييد "    
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "← بالكتم"    
elseif redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "← بالطرد"    
else
lock_user = "← ✖"    
end
if redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "← بالتقييد "    
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "← بالكتم"    
elseif redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "← بالطرد"    
else
lock_hash = "← ✖"    
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "← بالتقييد "   
elseif redis:get(bot_id.."LARICATEAM:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "← بالطرد"    
else
lock_bots = "← ✖"    
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "← ✔️"
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "← بالتقييد "    
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "← بالكتم"    
elseif redis:get(bot_id.."LARICATEAM:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "← بالطرد"    
else
lock_spam = "← ✖"    
end        
if not redis:get(bot_id.."LARICATEAM:Reply:Manager"..msg.chat_id_) then
ReplyManager = "← ✔️"
else
ReplyManager = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Reply:Sudo"..msg.chat_id_) then
ReplySudo = "← ✔️"
else
ReplySudo = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Lock:Id:Photo"..msg.chat_id_)  then
IdPhoto = "← ✔️"
else
IdPhoto = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Lock:Id:Py:Photo"..msg.chat_id_) then
IdPyPhoto = "← ✔️"
else
IdPyPhoto = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Cheking:Kick:Me:Group"..msg.chat_id_)  then
KickMe = "← ✔️"
else
KickMe = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Lock:Ban:Group"..msg.chat_id_)  then
Banusers = "← ✔️"
else
Banusers = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Cheking:Seted"..msg.chat_id_) then
Setusers = "← ✔️"
else
Setusers = "← ✖"
end
if redis:get(bot_id.."LARICATEAM:Link_Group"..msg.chat_id_) then
Link_Group = "← ✔️"
else
Link_Group = "← ✖"
end
if not redis:get(bot_id.."LARICATEAM:Fun:Group"..msg.chat_id_) then
FunGroup = "← ✔️"
else
FunGroup = "← ✖"
end
local Num_Flood = redis:hget(bot_id.."LARICATEAM:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 0
send(msg.chat_id_, msg.id_,"*\n• اعدادات المجموعه "..
"\n━━━━━━━━"..
...
redis:set(bot_id.."LARICATEAM:Developer:Bot:Reply"..msg.chat_id_,Teext)
...
redis:set(bot_id.."LARICATEAM:President:Group:Reply"..msg.chat_id_,Teext)
...
redis:set(bot_id.."LARICATEAM:Constructor:Group:Reply"..msg.chat_id_,Teext)
...
redis:set(bot_id.."LARICATEAM:Manager:Group:Reply"..msg.chat_id_,Teext) 
...
redis:set(bot_id.."LARICATEAM:Admin:Group:Reply"..msg.chat_id_,Teext)
...
redis:set(bot_id.."LARICATEAM:Vip:Group:Reply"..msg.chat_id_,Teext)
...
redis:set(bot_id.."LARICATEAM:Mempar:Group:Reply"..msg.chat_id_,Teext)
...
redis:del(bot_id.."LARICATEAM:Developer:Bot:Reply"..msg.chat_id_)
...
redis:del(bot_id.."LARICATEAM:President:Group:Reply"..msg.chat_id_)
...
redis:del(bot_id.."LARICATEAM:Constructor:Group:Reply"..msg.chat_id_)
...
redis:del(bot_id.."LARICATEAM:Manager:Group:Reply"..msg.chat_id_) 
...
redis:del(bot_id.."LARICATEAM:Admin:Group:Reply"..msg.chat_id_)
...
redis:del(bot_id.."LARICATEAM:Vip:Group:Reply"..msg.chat_id_)
...
redis:del(bot_id.."LARICATEAM:Mempar:Group:Reply"..msg.chat_id_)
...
local list = redis:smembers(bot_id.."LARICATEAM:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Text"..v..msg.chat_id_)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Photo"..v..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Video"..v..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:File"..v..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..v..msg.chat_id_)
redis:del(bot_id.."LARICATEAM:List:Manager"..msg.chat_id_)
end
...
text = "• قائمة الردود \n━━━━━━━━\n"
for k,v in pairs(list) do
if redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه "
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local list = redis:smembers(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = redis:get(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..v..msg.chat_id_)
if var then
...
local list = redis:smembers(bot_id.."LARICATEAM:Command:List:Group"..msg.chat_id_.."")
Command = "• قائمة الاوامر المضافه  \n━━━━━━━━\n"
for k,v in pairs(list) do
Commands = redis:get(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..v)
if Commands then 
...
local list = redis:smembers(bot_id.."LARICATEAM:Command:List:Group"..msg.chat_id_)
for k,v in pairs(list) do
redis:del(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..v)
redis:del(bot_id.."LARICATEAM:Command:List:Group"..msg.chat_id_)
end
...
local list = redis:smembers(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_)
for k,v in pairs(list) do;redis:del(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..v..msg.chat_id_);redis:del(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_);end
...
redis:set(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
redis:set(bot_id.."LARICATEAM:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
...
local list = redis:smembers(bot_id.."LARICATEAM:List:Rd:Sudo")
for k,v in pairs(list) do
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:Gif"..v)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:vico"..v)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:stekr"..v)     
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:Text"..v)   
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:Photo"..v)
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:Video"..v)
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:File"..v)
redis:del(bot_id.."LARICATEAM:Add:Rd:Sudo:Audio"..v)
redis:del(bot_id.."LARICATEAM:List:Rd:Sudo")
end
...
text = "\n• قائمة الردود العامه  \n━━━━━━━━\n"
for k,v in pairs(list) do
if redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Gif"..v) then
db = "متحركه "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:vico"..v) then
db = "بصمه "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:stekr"..v) then
db = "ملصق "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Text"..v) then
db = "رساله "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Photo"..v) then
db = "صوره "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Video"..v) then
db = "فيديو "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:File"..v) then
db = "ملف "
elseif redis:get(bot_id.."LARICATEAM:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه "
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
redis:set(bot_id.."LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
redis:set(bot_id.."LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
redis:set(bot_id.."LARICATEAM:Command:Reids:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
redis:set(bot_id.."LARICATEAM:Command:Reids:Group:Del"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
redis:del(bot_id.."LARICATEAM:Add:Validity:Group:Rt"..ComdNew..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_,ComdNew)  
...
redis:set(bot_id.."LARICATEAM:Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
redis:sadd(bot_id.."LARICATEAM:Validitys:Group"..msg.chat_id_,ComdNew)  
redis:setex(bot_id.."LARICATEAM:Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
send(msg.chat_id_, msg.id_, "\n• ارسل نوع الصلاحيه كما مطلوب منك :\n• انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، ادمن  ، مدير }") 
return false 
end
if text == 'المطور' or text == 'مطور' then
local TextingDevStorm = redis:get(bot_id..'LARICATEAM:Texting:DevSlbotss')
...
if redis:get(bot_id.."LARICATEAM:Broadcasting:Bot") and not Dev_Bots(msg) then 
...
redis:setex(bot_id.."LARICATEAM:Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
• ارسل الان النص
• يمكنك اضافه :
• `#username` » اسم المستخدم
...
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."LARICATEAM:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","??","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
redis:set(bot_id.."LARICATEAM:Random:Sm"..msg.chat_id_,SM)
...
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."LARICATEAM:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set(bot_id.."LARICATEAM:Klam:Speed"..msg.chat_id_,name)
...
if text == "حزوره" then
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."LARICATEAM:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
redis:set(bot_id.."LARICATEAM:Klam:Hzor"..msg.chat_id_,name)
...
if text == "معاني" then
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."LARICATEAM:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set(bot_id.."LARICATEAM:Maany"..msg.chat_id_,name)
...
if text == "العكس" then
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."LARICATEAM:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
redis:set(bot_id.."LARICATEAM:Set:Aks:Game"..msg.chat_id_,name)
...
redis:set(bot_id.."LARICATEAM:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n• اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."• ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."• سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
redis:setex(bot_id.."LARICATEAM:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
if redis:get(bot_id.."LARICATEAM:Lock:Game:Group"..msg.chat_id_) then   
Num = math.random(1,6)
redis:set(bot_id.."LARICATEAM:Games:Bat"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,[[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(bot_id.."LARICATEAM:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
redis:del(bot_id.."LARICATEAM:Set:Moktlf:Bot"..msg.chat_id_)
redis:set(bot_id.."LARICATEAM::Set:Moktlf"..msg.chat_id_,name)
...
redis:set(bot_id.."LARICATEAM:Set:Amth"..msg.chat_id_,name)
redis:del(bot_id.."LARICATEAM:Set:Amth:Bot"..msg.chat_id_)
...
if text == 'رسائلي' then
local nummsg = redis:get(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 1
send(msg.chat_id_, msg.id_,'• عدد رسائلك هنا *~ '..nummsg..'*') 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = redis:get(bot_id..'LARICATEAM:Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
send(msg.chat_id_, msg.id_,'• عدد التعديلات هنا *~ '..edit..'*') 
end
if text == 'جهاتي' then
local addmem = redis:get(bot_id.."LARICATEAM:Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
send(msg.chat_id_, msg.id_,'• عدد جهاتك المضافه هنا *~ '..addmem..'*') 
end
if text == "نقاطي" then 
local Num = redis:get(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(redis:get(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"• ليس لديك جواهر من الالعاب \n• اذا كنت تريد ربح نقاط \n• ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = redis:get(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n• ليس لديك جواهر بهاذا العدد \n• لزيادة نقاطك في اللعبه \n• ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
redis:decrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
redis:incrby(bot_id.."LARICATEAM:Num:Message:User"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
redis:set(bot_id.."LARICATEAM:id:user"..msg.chat_id_,yazon)  
redis:setex(bot_id.."LARICATEAM:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
send(msg.chat_id_, msg.id_, "• ارسل لي عدد الرسائل الان") 
return false
end
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then  
yazon = text:match("^اضف نقاط (%d+)$")
redis:set(bot_id.."LARICATEAM:idgem:user"..msg.chat_id_,yazon)  
redis:setex(bot_id.."LARICATEAM:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
send(msg.chat_id_, msg.id_, "• ارسل لي عدد النقاط الان") 
end
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف نقاط (%d+)$"))  
...
function reply(extra, result, success)
redis:del(bot_id.."LARICATEAM:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
redis:incrby(bot_id.."LARICATEAM:Num:Message:User"..msg.chat_id_..":"..result.sender_user_id_,text:match("^اضف رسائل (%d+)$"))  
...
redis:srem(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id.."LARICATEAM:Silence:User:Groups"..msg.chat_id_,result.id_)
...
redis:srem(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_,result.sender_user_id_)
redis:srem(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,result.sender_user_id_)
redis:srem(bot_id.."LARICATEAM:Silence:User:Groups"..msg.chat_id_,result.sender_user_id_)
...
function Function_Status(extra, result, success)
if result.id_ then
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Groups",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Groups",result.id_) then
GBanss = "مكتوم عام"
else
...
function Function_Status(extra, result, success)
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Group"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Group"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember(bot_id.."LARICATEAM:Removal:User:Groups",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
if redis:sismember(bot_id.."LARICATEAM:Silence:User:Groups",result.sender_user_id_) then
GBanss = "مكتوم عام"
else
GBanss = "غير مكتوم عام"
end
...
redis:sadd(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
redis:srem(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
redis:sadd(bot_id..'LARICATEAM:Admin:Group'..msg.chat_id_, admins[i].user_id_)
...
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
redis:set(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
redis:set(bot_id.."botss:LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
redis:sadd(bot_id.."botss:LARICATEAM:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
redis:del(bot_id..'botss:LARICATEAM:Add:Rd:Sudo:Text'..text)
redis:del(bot_id..'botss:LARICATEAM:Add:Rd:Sudo:Text1'..text)
redis:del(bot_id..'botss:LARICATEAM:Add:Rd:Sudo:Text2'..text)
redis:del(bot_id.."botss:LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."botss:LARICATEAM:List:Rd:Sudo", text)
return false
end
end
...
local list = redis:smembers(bot_id.."botss:LARICATEAM:List:Rd:Sudo")
for k,v in pairs(list) do  
redis:del(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text"..v) 
redis:del(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text1"..v) 
redis:del(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text2"..v)   
redis:del(bot_id.."botss:LARICATEAM:List:Rd:Sudo")
end
...
redis:set(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
redis:set(bot_id.."botss:LARICATEAM:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = redis:get(bot_id.."botss:LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:set(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = redis:get(bot_id.."botss:LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
redis:set(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = redis:get(bot_id.."botss:LARICATEAM:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
redis:set(bot_id.."botss:LARICATEAM:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = redis:get(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text"..text)   
local Text1 = redis:get(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text1"..text)   
local Text2 = redis:get(bot_id.."botss:LARICATEAM:Add:Rd:Sudo:Text2"..text)   
...
redis:sadd(bot_id.."LARICATEAM:President:Group"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
redis:set(bot_id..'LARICATEAM:Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
if redis:get(bot_id..'LARICATEAM:Lock:Game:Group'..msg.chat_id_) then
local list = redis:smembers(bot_id.."LARICATEAM:gamebot:List:Manager")
if #list ~= 0 then
...
[LARICATEAM Source](t.me/LARICATEAM)
...
redis:set(bot_id.."LARICATEAM:Set:Id:Group"..msg.chat_id_,Text_Rand)
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 or text == 'ID' and tonumber(msg.reply_to_message_id_) == 0 or text == 'Id' and tonumber(msg.reply_to_message_id_) == 0 or text == 'id' and tonumber(msg.reply_to_message_id_) == 0 and not redis:get(bot_id..'LARICATEAM:Lock:Id:Photo'..msg.chat_id_) then
...
local NumMessageEdit = redis:get(bot_id..'LARICATEAM:Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = redis:get(bot_id.."LARICATEAM:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = redis:get(bot_id.."LARICATEAM:Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local Get_Is_Id = redis:get(bot_id.."KLISH:ID:bot") or redis:get(bot_id.."LARICATEAM:Set:Id:Group"..msg.chat_id_)
if not redis:get(bot_id..'LARICATEAM:Lock:Id:Py:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = redis:get(bot_id..'LARICATEAM:Num:Message:User'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local NumMessageEdit = redis:get(bot_id..'LARICATEAM:Num:Message:Edit'..msg.chat_id_..data.id_) or 0
local Num_Games = redis:get(bot_id.."LARICATEAM:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = redis:get(bot_id.."LARICATEAM:Num:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'LARICATEAM:Lock:Id:Photo'..msg.chat_id_) or text and text:match("^كشف @(.*)$") and not redis:get(bot_id..'LARICATEAM:Lock:Id:Photo'..msg.chat_id_) then
...
redis:sadd(bot_id..'LARICATEAM:Num:User:Pv',v) 
end
...
redis:set(bot_id..'LARICATEAM:new:sourse'..msg.chat_id_..msg.sender_user_id_,'true1') 
send2(msg.chat_id_, msg.id_, 'ارسل رمز بدلا عن هاذا \n ━━━━━━━━')
return false
end
if redis:get(bot_id..'LARICATEAM:new:sourse'..msg.chat_id_..msg.sender_user_id_) == 'true1' then
redis:set(bot_id..'LARICATEAM:new:sourse1',text)
send2(msg.chat_id_, msg.id_, 'الان ارسل رمز بدلا عن • ')
redis:set(bot_id..'LARICATEAM:new:sourse'..msg.chat_id_..msg.sender_user_id_,'true2') 
return false
end
if redis:get(bot_id..'LARICATEAM:new:sourse'..msg.chat_id_..msg.sender_user_id_) == 'true2' then
redis:set(bot_id..'LARICATEAM:new:sourse2',text)
redis:del(bot_id..'LARICATEAM:new:sourse'..msg.chat_id_..msg.sender_user_id_) 
...
redis:del(bot_id..'LARICATEAM:new:sourse1')
redis:del(bot_id..'LARICATEAM:new:sourse2')
...
local list1 = redis:smembers(bot_id.."LARICATEAM:Constructor:Group"..msg.chat_id_)
local list2 = redis:smembers(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_)
local list3 = redis:smembers(bot_id.."LARICATEAM:Admin:Group"..msg.chat_id_)
local list4 = redis:smembers(bot_id.."LARICATEAM:Manager:Group"..msg.chat_id_)
...
if text and redis:get(bot_id.."LARICATEAM:Command:Reids:Group:Del"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = redis:get(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..text)
if NewCmmd then
redis:del(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..text)
redis:del(bot_id.."LARICATEAM:Command:Reids:Group:New"..msg.chat_id_)
redis:srem(bot_id.."LARICATEAM:Command:List:Group"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• تم ازالة هاذا ← { "..text.." }")  
else
send(msg.chat_id_, msg.id_,"• لا يوجد امر بهاذا الاسم")  
end
redis:del(bot_id.."LARICATEAM:Command:Reids:Group:Del"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text then
local NewCmmd = redis:get(bot_id.."LARICATEAM:Get:Reides:Commands:Group"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
elseif text and not redis:sismember(bot_id..'LARICATEAM:Spam_For_Bot'..msg.sender_user_id_,text) then
redis:del(bot_id..'LARICATEAM:Spam_For_Bot'..msg.sender_user_id_) 
elseif msg.content_.ID == "MessageChatAddMembers" then  
redis:set(bot_id.."LARICATEAM:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(bot_id.."LARICATEAM:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if msg.content_.ID == "MessageChatJoinByLink" and not redis:get(bot_id..'LARICATEAM:nwe:mem:group'..msg.chat_id_) then
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..'https://raw.githubusercontent.com/LARICATEAM/photo/master/'..numphotoid..'.jpg&reply_to_message_id='..Msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(redis:get(bot_id..'LARICATEAM:Num:Add:Bot') or 0) and not Dev_Bots(msg) then
send(msg.chat_id_, msg.id_,'• لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'LARICATEAM:Num:Add:Bot') or 0)..'* عضو')
return false
end
if redis:sismember(bot_id..'LARICATEAM:ChekBotAdd',msg.chat_id_) then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not redis:sismember(bot_id..'LARICATEAM:ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'• المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add','• تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'LARICATEAM:ChekBotAdd',msg.chat_id_)  
redis:del(bot_id..'LARICATEAM:ChekBot:Add'..msg.chat_id_)
...
if redis:get(bot_id..'LARICATEAM:ChekBot:Add'..msg.chat_id_) == 'addsender' then
...
redis:sadd(bot_id..'LARICATEAM:ChekBotAdd',Chat_id)
redis:set(bot_id..'LARICATEAM:ChekBot:Add'..Chat_id,'addsender')
...
owner_id = admins[i].user_id_
redis:sadd(bot_id.."LARICATEAM:President:Group"..Chat_id, owner_id)
end
end
end,nil)   
...
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape('• تم تفعيل مجموعه ')..'&message_id='..msg_idd) 
redis:sadd(bot_id..'LARICATEAM:ChekBotAdd',Chat_id)
redis:del(bot_id..'LARICATEAM:ChekBot:Add'..Chat_id)
tdcli_function ({ID = "GetChannelMembers",channel_id_ = Chat_id:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,datta) 
local admins = datta.members_
for i=0 , #admins do
if datta.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
redis:del(bot_id..'LARICATEAM:Link_Group'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Chek:Welcome'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Reply:Sudo'..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Lock:Id:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Lock:Id:Py:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Lock:Ban:Group'..Chat_id,'true')
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Cheking:Seted'..Chat_id,'true')
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Cheking:Kick:Me:Group'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Lock:Game:Group'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Reply:Manager'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Link_Group'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Chek:Welcome'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Reply:Sudo'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Lock:Id:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Lock:Id:Py:Photo'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Lock:Ban:Group'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Cheking:Seted'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Cheking:Kick:Me:Group'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id..'LARICATEAM:Lock:Game:Group'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:del(bot_id..'LARICATEAM:Reply:Manager'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
redis:set(bot_id.."LARICATEAM:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
redis:set(bot_id.."LARICATEAM:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:User:Name"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Sticker"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Animation"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Video"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Photo"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Audio"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:vico"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Document"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Contact"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Spam"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:hset(bot_id.."LARICATEAM:Spam:Group:User"..Chat_id ,"Spam:User",'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:set(bot_id.."LARICATEAM:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:AddMempar"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:text"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Join"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Bot:kick"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:edit"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Link"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Spam"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:hdel(bot_id.."LARICATEAM:Spam:Group:User"..Chat_id ,"Spam:User")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:del(bot_id.."LARICATEAM:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
redis:incr(bot_id..'LARICATEAM:Num:Message:Edit'..result.chat_id_..result.sender_user_id_)
if redis:get(bot_id.."LARICATEAM:Lock:edit"..msg.chat_id_) and not textedit and not PresidentGroup(result) then
...
if redis:get(bot_id.."LARICATEAM:Lock:Link"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
...
if redis:get(bot_id.."LARICATEAM:Lock:User:Name"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("@") then
...
elseif textedit and textedit:match("(.*)(#)(.*)") then
if redis:get(bot_id.."LARICATEAM:Lock:hashtak"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("#") then
...
elseif textedit and textedit:match("/") then
if redis:get(bot_id.."LARICATEAM:Lock:Cmd"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
elseif textedit and textedit:match("(.*)(/)(.*)") then
...
local Text_Filter = redis:get(bot_id.."LARICATEAM:Filter:Reply2"..textedit..result.chat_id_)   
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
...
local Get_Msg_Pin = redis:get(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;redis:del(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) redis:del(bot_id..'BotLARICATEAM:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
redis:srem(bot_id..'LARICATEAM:ChekBotAdd',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
redis:srem(bot_id..'LARICATEAM:ChekBotAdd',v)  
end
...
redis:sadd(bot_id..'LARICATEAM:ChekBotAdd',v)  
end 
end,nil)
end
end
